...
class Scheduler:
    ...
    def isdoctoravailable(self,doctor,time):
        if  doctor.doctor_calendar[CLASS_APPOINTMENT_INFO].__contains__(time):
    ...
    def ispatientavailable(self,patient,time):
        if patient.patient_calendar[CLASS_APPOINTMENT_INFO].__contains__(time):
...
P3= Patient("Akash","Goyal","12311")



S1 = Scheduler()
S1.schedule(D1,P1,SLOT_11)
S1.schedule(D1,P2,SLOT_11)
S1.schedule(D2,P3,SLOT_1)

P1.print_patient_calendar()
P2.print_patient_calendar()
P3.print_patient_calendar()
